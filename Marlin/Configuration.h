...
#define STRING_CONFIG_H_AUTHOR "(G.M., Sapphire Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // SapphirePro 24V Heater AutoTuned @ S60 C8
  #define DEFAULT_bedKp 16.66
  #define DEFAULT_bedKi 3.06
  #define DEFAULT_bedKd 60.54
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 403.03 } // Calibrated stock extruder - 403.03
 ...
 */
#define DEFAULT_ACCELERATION          2500    // X, Y, Z and E acceleration for printing moves         2500
#define DEFAULT_RETRACT_ACCELERATION  4000    // E acceleration for retracts                           2500
#define DEFAULT_TRAVEL_ACCELERATION   2500    // X, Y, Z acceleration for travel (non printing) moves  2500
...
#define MANUAL_PROBE_START_Z 0.05 // 0.2
...
#define XY_PROBE_SPEED 10500 //(133*60)
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 31, 32, 32, 30 } // (mm) Left, Front, Right, Back insets
  #define LEVEL_CORNERS_HEIGHT      0.0   // (mm) Z height of nozzle at leveling points | np. grubość kartki lub szczelinomierza
